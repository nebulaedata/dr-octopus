/**
 * @author Codex
 * @description Exposes the official shadcn Questionnaire composition primitives for shared application forms.
 */
...
import { buttonVariants, type Button } from "@octopus/ui/components/button"
