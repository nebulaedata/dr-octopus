  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: t('settings.nav.mcp.description', 'Add and manage MCP server connections and available tools.'),
          path: '/settings/mcp',
          icon: NetworkIcon,
          pageType: 'complete',
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: t('settings.nav.licenses.description', 'The open-source licenses page is not available yet.'),
 ...
 */
export function findSettingsNavigationItem(t: Translate, pathname: string): SettingsNavigationItem | undefined {
