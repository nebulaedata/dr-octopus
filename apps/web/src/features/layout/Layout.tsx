...
import { useDataEventsLifecycle } from '@/queries/data-events-queries';
import { useRealtimeLifecycle } from '@/queries/realtime-queries';
import { useWorkbenchHome } from '@/stores/workbench-home';
import { ShortcutKeyRegister } from '@/lib/shortcuts';
import { useShortcut } from '@/hooks/use-shortcut';
import { Header } from '@/features/layout/Header';
import { getSiblingSession } from '@/features/layout/utils/session-navigation';
import { Sidebar } from '@/features/layout/Sidebar';
import { ConnectionStatus } from '@/features/layout/ConnectionStatus';
import { SessionPropertiesPanel } from '@/features/layout/SessionPropertiesPanel';
import { FileExplorerPanel } from '@/features/session';
