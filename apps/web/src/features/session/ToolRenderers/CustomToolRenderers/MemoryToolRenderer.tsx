...
import { projectMemoryTool } from '@/features/session/utils/memory-tool-projection';
      ...
      {data.items.length ? (
        ...
        <Empty className="py-7">
          <EmptyHeader>
            ...
            <EmptyDescription>
              {t(
                'session.memoryTool.emptyDescription',
                'Try different keywords, or browse the memory library.'
              )}
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
