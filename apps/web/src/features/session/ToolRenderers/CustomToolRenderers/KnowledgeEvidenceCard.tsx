...
import type { KnowledgeEvidence } from '@/features/session/utils/knowledge-projection';
          ...
          <DialogContent className="max-h-[calc(100dvh-2rem)] overflow-y-auto sm:max-w-2xl">
            <DialogHeader className="min-w-0">
              ...
              <DialogDescription className="wrap-anywhere">
                {evidence.locator}
                {' · '}
                {t('session.knowledgeEvidence.snapshotNote', 'Material snapshot returned by this tool call')}
              </DialogDescription>
            </DialogHeader>
            <Separator />
            <KnowledgeEvidenceText evidence={evidence} />
