...
import { projectKnowledgeEvidence } from './knowledge-projection';
  ...
  return (
    <div className="@container flex min-w-0 flex-col gap-4">
      <KnowledgeHeading
        ...
        description={t('session.knowledgeTool.searchDescription', 'Material fragments related to this question')}
  ...
  return (
    <div className="@container flex min-w-0 flex-col gap-4">
      <KnowledgeHeading
        ...
        description={t('session.knowledgeTool.catalogDescription', 'Knowledge collections accessible this time')}
...
function KnowledgeLoading() {
  ...
  return (
    <div
      ...
      role="status"
      aria-label="Searching knowledge materials"
    >
