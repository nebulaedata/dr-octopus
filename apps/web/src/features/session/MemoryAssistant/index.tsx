...
import { describeMemoryAssistantState } from './memory-assistant-status';
import { useMemoryAssistantDrag } from './use-memory-assistant-drag';
import type { MemoryAssistantTone } from './memory-assistant-status';
      ...
      <div className={cn('flex items-center gap-1.5', bubbleSide === 'left' && 'flex-row-reverse')}>
        ...
        <div className="relative">
          ...
          <button
            ...
            title={t('memory.assistant.dismissTitle', 'Dismiss the memory assistant (reappears after a refresh)')}
