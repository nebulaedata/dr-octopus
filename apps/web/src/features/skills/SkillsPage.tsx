...
import { EffectiveSkillSection } from '@/features/skills/EffectiveSkillSection';
import { SkillDeleteDialog } from '@/features/skills/SkillDeleteDialog';
import { SkillDetailDialog } from '@/features/skills/SkillDetailDialog';
import { SkillEditDialog } from '@/features/skills/SkillEditDialog';
import { SkillSection } from '@/features/skills/SkillSection';
import { SkillUploadDialog } from '@/features/skills/SkillUploadDialog';
      ...
      <Page classNames={{ container: 'overflow-hidden', content: 'gap-6' }}>
        <PageHero
          ...
          description={t(
            ...
            'View loaded skills and manage workspace and global skills.'
          )}
          extra={
            <>
              <SearchInput
          ...
          <ScrollArea className="min-h-0 pt-3 pr-2 overflow-y-auto">
              ...
              <SkillSection
                ...
                description={
                  workspaceName === undefined
                    ? t(
                        'skills.page.workspaceDescription',
                        'Only used by new sessions in the current workspace.'
                      )
                    : t(
                        'skills.page.workspaceDescriptionNamed',
                        'Only used by new sessions in workspace "{{name}}".',
                        {
                          name: workspaceName,
                        }
                      )
            ...
            <TabsContent value="global">
              <SkillSection
                ...
                description={t(
                  'skills.page.globalDescription',
                  'Reused by new sessions across all workspaces.'
                )}
