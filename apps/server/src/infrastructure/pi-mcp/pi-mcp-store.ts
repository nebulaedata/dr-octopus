...
import type { CreatePiMcpStoreOptions, PiMcpAdapterConfigApi, PiMcpConfig } from './types.js';
 ...
 */
export function createPiMcpStore(options: CreatePiMcpStoreOptions): DefaultPiMcpStore {
  return new DefaultPiMcpStore(options);
}

export class DefaultPiMcpStore {
