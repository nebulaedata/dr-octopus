...
import { PiMcpConfigError } from '../../infrastructure/pi-mcp/index.js';
import type {
  CreateMcpServerBody,
  UpdateMcpServerActivationBody,
  UpdateMcpServerBody,
} from '@octopus/shared/protocol';
import type { DefaultPiMcpStore } from '../../infrastructure/pi-mcp/index.js';
...
export class McpSettingsService {
  ...
  public constructor(private readonly store: DefaultPiMcpStore) {}
