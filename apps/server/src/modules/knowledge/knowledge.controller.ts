...
export const knowledgeErrorMessages: ErrorMessageCatalog = {
  ...
  ATTACHMENT_REF_INVALID: [
    ...
    {
      match: '附件导入凭据无效',
      en: 'The attachment import credential is invalid.',
      'zh-CN': '附件导入凭据无效',
    },
  ],
  AUTH_REQUIRED: [
    {
      en: 'Valid credentials are required; complete the configuration and try again.',
      'zh-CN': '缺少有效凭据，请完成配置后重试。',
    },
    {
      match: 'MCP 环境变量未配置',
      en: 'The MCP environment variables are not configured.',
      'zh-CN': 'MCP 环境变量未配置',
    },
    {
    ...
    {
      match: '远端知识库令牌无效',
      en: 'The remote knowledge token is invalid.',
      'zh-CN': '远端知识库令牌无效',
    },
  ],
  ...
  FORBIDDEN: [
    ...
    {
      match: '不能列举其他工作区',
      en: 'Listing other workspaces is not permitted.',
      'zh-CN': '不能列举其他工作区',
    },
    {
      match: '只能发布本地全局集合',
    ...
    {
      match: '文件不在当前工作区内',
      en: 'The file is outside the current workspace.',
      'zh-CN': '文件不在当前工作区内',
    },
    {
      match: '未授权在此范围创建集合',
  ...
  INVALID_ENDPOINT: [
    ...
    {
      match: '目标网络地址不允许',
      en: 'The target network address is not allowed.',
      'zh-CN': '目标网络地址不允许',
    },
    {
  ...
  MODEL_CONFIG_INVALID: [
    ...
    {
      match: '模型名称或超时无效',
      en: 'The model name or timeout is invalid.',
      'zh-CN': '模型名称或超时无效',
    },
    {
      match: '模型名称或超时配置无效',
    ...
    {
      match: '模型地址不是有效 URL',
      en: 'The model endpoint is not a valid URL.',
      'zh-CN': '模型地址不是有效 URL',
    },
    {
  ...
  MODEL_NOT_CONFIGURED: [
    ...
    {
      match: '请配置 Embedding 模型',
      en: 'Configure an Embedding model first.',
      'zh-CN': '请配置 Embedding 模型',
    },
  ],
  MODEL_RESPONSE_INVALID: [
    ...
    {
      match: 'Embedding 返回零向量',
      en: 'Embedding returned a zero vector.',
      'zh-CN': 'Embedding 返回零向量',
    },
  ...
  NOT_FOUND: [
    {
      en: 'The target no longer exists; refresh and try again.',
      'zh-CN': '目标已删除或不存在，请刷新后重试。',
    },
  ...
  OCR_NOT_CONFIGURED: [
    {
      en: 'Configure OCR in the knowledge model settings first.',
      'zh-CN': '请先在知识库模型设置中配置 OCR。',
    },
  ...
  RELEASE_IN_USE: [
    {
      en: 'The runtime directory is being updated; try again later.',
      'zh-CN': '运行目录正在更新，请稍后重试。',
    },
    {
      match: '当前发行目录正在安装依赖',
  ...
  REVISION_EXPIRED: [
    ...
    {
      match: '远程目录已变更，请重试',
      en: 'The remote listing changed; try again.',
      'zh-CN': '远程目录已变更，请重试',
    },
  ],
  SOURCE_CORRUPT: [
